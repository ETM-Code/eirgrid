...
use super::action_weights::{GridAction, evaluate_action_impact};
...
fn metrics_to_action_result(metrics: &super::action_weights::SimulationMetrics) -> super::action_weights::ActionResult {
    super::action_weights::ActionResult {
...
mod csv_export {
    ...
    use crate::data::poi::POI; // Trait for get_coordinate and other location methods
    ...
    impl CsvExporter {
        ...
        pub fn export_simulation_results(
            &self,
            actions: &[(u32, crate::core::action_weights::GridAction)],
            metrics: &crate::core::action_weights::SimulationMetrics,
            yearly_metrics: &[YearlyMetricsExport],
            map: &crate::utils::map_handler::Map,
            ...
            for (year, action) in actions {
                match action {
                    crate::core::action_weights::GridAction::AddGenerator(gen_type) => {
                    ...
                    crate::core::action_weights::GridAction::UpgradeEfficiency(gen_id) => {
                    ...
                    crate::core::action_weights::GridAction::AdjustOperation(gen_id, percentage) => {
                    ...
                    crate::core::action_weights::GridAction::AddCarbonOffset(offset_type) => {
                    ...
                    crate::core::action_weights::GridAction::CloseGenerator(gen_id) => {
                    ...
                    crate::core::action_weights::GridAction::DoNothing => {
            ...
            for metric in yearly_metrics {
                ...
                for (_, action) in year_actions {
                    if let crate::core::action_weights::GridAction::AddGenerator(gen_type) = action {
            ...
            for metric in yearly_metrics {
                ...
                let year_actions = actions.iter().filter(|(action_year, _)| *action_year == year);
                for (_, action) in year_actions {
                    if let crate::core::action_weights::GridAction::AddCarbonOffset(offset_type) = action {
                        // Generate unique ID
